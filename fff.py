...
df = pd.read_csv("/media/data/datasets/yelp/food/ethnic_food_top10categories-sentences-vectors.tsv", sep="\t")
...
df.to_csv("\media\data\datasets\yelp\food\that_thing.tsv", sep="\t")
